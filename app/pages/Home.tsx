                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full">
                                ...
                                <span className="text-sm font-medium">18+ Years in Strategy, Research & Advisory</span>
                            </div>

                            {/* Main Heading */}
                            <h1 className="text-4xl md:text-5xl lg:text-2xl  text-primary">
                                Strategy, Market Intelligence & Growth Advisor
                            </h1>

                            {/* Description */}
                            <div className="space-y-6">
                                <p className="text-lg text-gray-700">
                                    I bring 18+ years of experience supporting business leaders, investors and institutions in addressing complex growth, market-entry and investment decisions through market intelligence, structured analysis and design-led problem solving
                                </p>
                                <p className="text-lg text-gray-700" >
                                    I currently lead Market Research & Advisory initiatives at Kepler Consulting and contribute to the development of Kepler Ventures in India.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-6 pt-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-sm text-gray-600 mt-1">250+ Advisory & Research Engagements</div>
                                </div>
                            ...
                            {/* Services */}
                            <div className="pt-8">
                                <h3 className="text-xl font-semibold text-primary mb-4">Core Areas of Expertise</h3>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900">Growth Strategy & Business Planning</h4>
                                            <p className="text-sm text-gray-600 mt-1">Experience in evaluating growth opportunities, strategic priorities and implementation roadmaps.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900">Market Intelligence & Entry Strategy</h4>
                                            <p className="text-sm text-gray-600 mt-1">Experience in market assessment, competitive intelligence, positioning and market-entry planning.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3">
                                        <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900">Feasibility & Investment Assessment</h4>
                                            <p className="text-sm text-gray-600 mt-1">Experience in evaluating commercial potential, investment viability, risks and strategic priorities across markets.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative flex flex-col items-center justify-start">
                                ...
                                <div className="pt-6 w-full justify-items-center">
                                    ...
                                    <p className="text-md text-gray-600 mt-2">
                                        Strategy, Market Intelligence & Growth Advisor <br />
                                        <a
                                            href="https://www.kepler-consulting.com/en/"
                                            target="_blank"
                                        ...
                                        {" | "}
                                        <a
                                            href="https://www.kepler-ventures.com/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className=" hover:underline"
                                        >
                                            Kepler Ventures India
                                        </a>
                                    </p>
