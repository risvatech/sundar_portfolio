...
function CategoryManager() {
  ...
  const updateCategoryMutation = useApiMutation({
    url: (id) => `/blog/categories/update/${id}`,
    method: "put",
    onSuccessExtra: () => {
      resetForm();
      fetchCategories();
  ...
  const deleteCategoryMutation = useApiMutation({
    url: (id) => `/blog/categories/delete/${id}`,
    method: "delete",
    onSuccessExtra: () => {
      fetchCategories();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editCategory) {
        // FIX: Send an object with the name, not just the ID
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Add, edit, or remove blog categories from your system.
        </p>
      </div>

      {/* Form Section */}
      <div className="bg-white rounded-lg text-secondary border border-gray-200 p-6 mb-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              disabled={isMutationLoading || loading}
            />
          </div>
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              disabled={isMutationLoading || loading || !name.trim()}
              className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                isMutationLoading || loading || !name.trim()
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={isMutationLoading}
                    className="px-3 py-1.5 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Delete
                  </button>
                </div>
