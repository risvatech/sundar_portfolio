            ...
            <div className="bg-card rounded-2xl p-6 md:p-8 shadow-soft">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">
                        Please share a few details, and I will get back to you
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6">
                    ...
                    {/* Service Type Field */}
                    <div>
                        <label className="text-sm font-medium mb-1 block">Nature of Enquiry *</label>
                        <Select
                            onValueChange={(value) => {
                    ...
                    {/* Description Field */}
                    <div>
                        <label className="text-sm font-medium mb-1 block">Message / Context *</label>
                        <Textarea
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            Briefly share the purpose of your enquiry, topic of interest or potential area of collaboration.
                        </p>
                    </div>
