...
export const services: Service[] = [
  {
    ...
    description: "Experience in assessing markets, customers, competitors and emerging opportunities to support informed growth and investment decisions.",
    features: ["B2B & B2G Market Research", "Competitive Intelligence", "Market Sizing: TAM, SAM & SOM", "Industry Trends & Foresight"],
  ...
  },
  {
    ...
    description: "Experience in shaping market-entry, commercialization and growth strategies aligned with customer needs, competitive dynamics and organizational capabilities.",
    features: ["Go-to-Market Strategy", "Market-Entry Strategy", "Sales Transformation", "Pricing, Positioning & Channel Strategy"],
  ...
  },
  {
    ...
    description: "Experience in evaluating market potential, commercial viability, financial assumptions, strategic risks and investment scenarios.",
    features: ["Techno-Commercial Feasibility", "Business Cases & Financial Models", "Investment Decision Support", "Risk & Scenario Analysis"],
  ...
  },
  {
    ...
    description: "Applying human-centred and structured problem-solving approaches to understand customer needs, define business challenges and validate new concepts.",
    features: ["Design Thinking Workshops", "Customer Journey Mapping", "New Product & Service Strategy", "Concept Validation"],
  ...
  },
  {
    ...
    icon: Monitor,
    title: "Leadership & Strategic Decision Support",
    description: "Experience supporting leadership teams with structured analysis for growth, diversification, portfolio, sourcing and investment decisions.",
    features: ["Executive Decision Support","Growth & Diversification Roadmaps","Portfolio Strategy","Strategic Sourcing"],
  ...
  },
  {
    ...
    description: "Sharing practical frameworks, industry perspectives and real-world experience through executive sessions, academic interactions and professional forums.",
    features: ["Guest Lectures & Executive Sessions", "Strategy & Consulting Frameworks", "Design Thinking for Business Leaders", "Case-Based Learning"],
