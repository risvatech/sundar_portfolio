            ...
            <div className="mx-auto max-w-7xl ">
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <h2 className="text-2xl md:text-2xl font-bold leading-snug md:leading-tight text-gray-900">
                            I bring together strategy, market intelligence, customer insight, and supply-chain realities to shape growth plans that are practical, scalable, and profitable.
                        </h2>
                        <h2 className="text-2xl md:text-2xl font-bold leading-snug md:leading-tight text-gray-900">
                            Experience spanning market entry, growth strategy, feasibility assessment, customer research, strategic sourcing, and business transformation.
                        </h2>
